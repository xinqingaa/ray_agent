...
本章两个确定性实验与相关产品测试已运行；五类任务的完整真实模型评估、产品长操作取消与断连恢复等仍未完成。运行条件和缺口见[制作进度](progress.md#第-16-章可靠性验证与评估)。方法能够覆盖这些问题，不表示所有问题已经得到通过结论。
...
当任务延伸到长期项目，材料、约束和产物还会跨次执行积累。下一章继续研究项目工作区：怎样让这些信息保持可用，并在更长的时间范围里维持同样可验证的交接。
