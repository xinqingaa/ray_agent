...
01–17 章骨架已建立，章节标题与目录显示名称已统一为中文，英文文件名不变。第 01 章已移除文末源码与制作验证区，正文以任务机制和学习衔接收尾；作者核对入口集中在 map。两张 SVG 在 OpenAI 简洁风格上采用浅灰背景、淡蓝分组、8 px 圆角、3 px 节点边框和 4 px 流程箭头。其余章节仍为骨架。
